// We need this file, which is a copy of infraspace buildings.json file, stripped of trailing commas and comments),
// since TypeScript is unable to do proper narrowing on JSON imports. See https://github.com/microsoft/TypeScript/issues/32063.
